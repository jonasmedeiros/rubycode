  ...
  module Adapters
    ...
    class Openai < Base
      ...
      def validate_api_key!
        ...
        raise AdapterError, I18n.t("rubycode.errors.openai.api_key_missing")
      end

      def get_api_key
        # Check database first
        db_key = Models::ApiKey.get_key(adapter: :openai)
      ...
      def debug_request(uri, payload)
        ...
        puts "\n#{separator}"
        puts I18n.t("rubycode.debug.request_title_adapter", adapter: "OpenAI")
        puts separator
      ...
      def debug_response(body)
        separator = I18n.t("rubycode.debug.separator")
        puts "\n#{separator}"
        puts I18n.t("rubycode.debug.response_title_adapter", adapter: "OpenAI")
        puts separator
